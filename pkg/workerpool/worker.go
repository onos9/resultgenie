...
func (w *worker) executeTask(t task, pool *workerPool) (result interface{}, err error) {
...
func (w *worker) executeTaskWithTimeout(t task, pool *workerPool) (result interface{}, err error) {
...
func (w *worker) executeTaskWithoutTimeout(t task, pool *workerPool) (result interface{}, err error) {
	// If timeout is not set or is zero, just run the task
	return t()
}

// handleResult handles the result of a task.
func (w *worker) handleResult(result interface{}, err error, pool *workerPool) {
